...
if __name__=="__main__":
    ...
    tk.Label(root,text="网站1: ",padx=10,pady=10,font=5).grid(row=0)
    tk.Label(root,text="网站2: ",padx=10,font=5).grid(row=1)
    input1=tk.Entry(root,width=60,font=5)
    input1.grid(row=0,column=1,)
    input2=tk.Entry(root,width=60,font=5)
    input2.grid(row=1,column=1)
    tk.Button(root,text="计算",width=7,height=2,font=4,command=show).grid(row=2,column=1,padx=30)
